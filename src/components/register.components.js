...
class Register extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            axios.post('/trainee/register',data)
            .then(response=>{
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <Input id="password" value={data.password} type="password" invalid={errors.password ? true : false} name="password" onChange={this.handleChange} />
                    <FormFeedback>{errors.password}</FormFeedback>
                </FormGroup>

                <FormGroup>
                    <Label for="confirmPassword">Confirm Password </Label>
                    <Input id="confirmPassword" value={data.confirmPassword} type="password" invalid={errors.confirmPassword ? true : false} name="confirmPassword" onChange={this.handleChange} />
